    ...
    return (  
        <View style={styles.container}>
            <View style={styles.productWrapper}>
                <Image style={styles.productLogo} source={require('../assets/img/usb.png')} />
            ...
            <View style={styles.starWrapper}>
                <Image style={styles.starImg} source={require('../assets/img/Star 1.png')} />
                <Image style={styles.starImg} source={require('../assets/img/Star 1.png')} />
                <Image style={styles.starImg} source={require('../assets/img/Star 1.png')} />
                <Image style={styles.starImg} source={require('../assets/img/Star 1.png')} />
                <Image style={styles.starImg} source={require('../assets/img/Star 1.png')} />
            ...
            <TouchableOpacity style={styles.addImageBtn}>
                <Image style={styles.cameraImg} source={require('../assets/img/camera.png')} />
                <Text style={styles.addImageTxt}>Thêm hình ảnh</Text>
            </TouchableOpacity>
            <View style={styles.inputWrapper}>
            <TextInput style={styles.shareInput} placeholder='Hãy chia sẻ những điều mà bạn thích về sản phẩm' multiline={true} numberOfLines={10} placeholderTextColor={'gray'} onChangeText={setFeedback} />
